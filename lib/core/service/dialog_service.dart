...
class DialogService {
  late Function(String title, String? message, String confirmText, bool fixed) _showDialogListener;
  Completer? _dialogCompleter;

  /// Registers a callback function. Typically to show the dialog
  void registerDialogListener(Function showDialogListener) {
    _showDialogListener = showDialogListener as dynamic Function(String, String?, String, bool);
    ;
  }
